...
import { getAccountFromStorage } from "../../utils/helpers";
...
const accountSlice = createSlice({
  ...
  reducers: {
    ...
    loadAccount(state, action) {
      ...
      const stored = getAccountFromStorage(username);
      if (stored) {
        state.balance = stored.balance;
        state.loan = stored.loan;
        state.loanPurpose = stored.loanPurpose;
        state.transactionHistory = stored.transactionHistory;
      }
    },
